...
(function (global, factory) {
  ...
  function () {
    function Distpicker(element, options) {
      ...
      if (options.area && options.area.length > 0 && options.area != 0) {
        var area_id = options.area;
        if (area_id.substring(2, 6) == "0000") {
            var province = area_id;
            var city = 0;
            var district = 0;
        } else if (area_id.substring(4, 6) == "00") {
            var province = area_id.substring(0, 2)+"0000";
            var city = area_id;
            var district = 0;
        } else {
            var province = area_id.substring(0, 2)+"0000";
            var city = area_id.substring(0, 4)+"00";
            var district = area_id;
        }
    ...
    _createClass(Distpicker, [{
      ...
      key: "getAreaFullName",
      value: function getAreaFullName() {
        var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CODE;
        if (code.substring(2, 6) == "0000") {
          return DISTRICTS["100000"][code];
        } else if (code.substring(4, 6) == "00") {
          return DISTRICTS["100000"][code.substring(0, 2)+"0000"] + "/" + DISTRICTS[code.substring(0, 2)+"0000"][code];
        } else {
          return DISTRICTS["100000"][code.substring(0, 2)+"0000"] + "/" + DISTRICTS[code.substring(0, 2)+"0000"][code.substring(0, 4)+"00"] + "/" + DISTRICTS[code.substring(0, 4)+"00"][code];
        }
      }
    }, {
      key: "getAreaName",
      value: function getAreaName() {
        var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CODE;
        if (code.substring(2, 6) == "0000") {
          return DISTRICTS["100000"][code] || null
        } else if (code.substring(4, 6) == "00") {
          return DISTRICTS[code.substring(0, 2)+"0000"][code] || null;
        } else {
          return DISTRICTS[code.substring(0, 4)+"00"][code] || null;
        }
      }
    }, {
      key: "getDistricts",
      ...
      key: "getDistrictsCode",
      value: function getDistrictsCode(province, city, district) {
        let province_code = DISTRICTS["100000"] && findKey(DISTRICTS["100000"], province) || 0;
        let city_code = DISTRICTS[province_code] && findKey(DISTRICTS[province_code], city) || 0;
        let district_code = DISTRICTS[city_code] && findKey(DISTRICTS[city_code], district) || 0;
