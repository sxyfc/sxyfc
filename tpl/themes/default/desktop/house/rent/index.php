...
$lists = set_model("house_rent")->where($where)->order('id desc')->paginate(8);
...
<div class=" mhcms-container">
    <div id="app_mhcms">
        ...
        <div class="row columns is-multiline is-marginless">
            ...
            $_item= \app\common\model\Models::get_item($item['id'] , 'house_rent');
            $is_developer = false;
            ?>
            <a class="column is-3" href="{:url('house/rent/detail' , ['id'=>$item.id])}">
                        ...
                        <div class="media">
                            ...
                            <div class="media-content">
                                ...
                                <p><span class="title is-6">{$_item.area_id|default='-'}</span>
                                    <span class=" is-6 is-pulled-right has-text-danger">{$_item.price|default='-'}万</span>
                                </p>
                            </div>
                        </div>
