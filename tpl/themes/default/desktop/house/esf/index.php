...
$lists = set_model("house_esf")->where($where)->order('id desc')->paginate(8);
...
<div class=" mhcms-container">
    <div id="app_mhcms">
        ...
        <div class="row columns is-multiline is-marginless">
            ...
            $_item= \app\common\model\Models::get_item($item['id'] , 'house_esf');
            $is_developer = false;
            ?>
            <a class="column is-3" href="{:url('house/esf/detail' , ['id'=>$item.id])}">
