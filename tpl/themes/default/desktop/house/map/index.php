...
<div id="app_mhcms">
    ...
    <div id="top_nav" class="weui-navbar " style="position: static">
        <span class="weui-navbar__item weui-bar__item_on">新房</span>
                ...
                if(data.data.length > 0){
                    $.each(data.data , function (index ,  item) {
                        ...
                        myCompOverlay.addEventListener('click',function(){
                            mhcms_frame_work.open_frame(myCompOverlay._data.loupan_name,"/house/loupan/map_info?id="+myCompOverlay._data.id , '100%' , '70vh' , 'b');
                        });
