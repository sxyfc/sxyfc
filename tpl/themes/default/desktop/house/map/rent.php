...
<div id="app_mhcms">
    ...
    <div id="top_nav" class="weui-navbar " style="position: static">
        <a class="weui-navbar__item" href="{:url('house/map/index')}">新房</a>
        <a class="weui-navbar__item "  href="{:url('house/map/esf')}">二手房</a>
        <a class="weui-navbar__item weui-bar__item_on">租房</a>
    </div>
                ...
                if(data.data.length > 0){
                    $.each(data.data , function (index ,  item) {
                        ...
                        myCompOverlay.addEventListener('touchstart',function(){
                            mhcms_frame_work.open_frame(myCompOverlay._data.loupan_name + "出租房列表","/house/loupan/map_rent_list?id="+myCompOverlay._data.id , '100%' , '70vh' , 'b');
                        });
