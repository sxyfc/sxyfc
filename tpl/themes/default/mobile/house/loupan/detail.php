...
<div class="weui-flex loupan_nav has-text-centered">
    ...
    <div class="weui-flex__item"><a href="{:url('house/loupan/esf',['loupan_id'=>$detail['id']])}" class="placeholder"><i class="icon4"></i><p>房源</p></a></div>
    <div class="weui-flex__item"><a href="{:url('house/loupan/rent',['loupan_id'=>$detail['id']])}" class="placeholder"><i class="icon5"></i><p>租房</p></a></div>
</div>
...
<div class="ui top attached mhcms-panel" id="intro">
    ...
    <div class="ui column mhcms-panel-body" style="    margin-bottom: 10px;padding-top: 0;">
        ...
        <div class="columns is-mobile is-marginless is-multiline mhcms-property">
...
<script>
    require(['jquery' , 'swiper4' ] , function ($ , Swiper) {
        $(document).ready(function () {
            var swiper = new Swiper('#loupan_huxing', {
