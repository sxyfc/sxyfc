...
<div class="mh_header columns is-mobile is-marginless">
    ...
    <a class="back column is-narrow is-paddingless" href="/house">
        <div style="padding: 0px 0px 0 15px"><img class="image is-rounded is-32x32" src="{$logo}" style="    margin-top: 7px;border-radius: 50%"></div>
    </a>
    {/if}
...
<div id="app_mhcms"  v-lazy-container="{ selector: 'img' }">
    ...
    <div class="slider_wraper" style="  background: #fff;">
        <div class="blender">
            ...
            <div class="swiper-container swiper-container-horizontal new-better-swiper-container" id="index_ad" style="overflow: hidden; max-height: 200px;">
                <div  class="swiper-wrapper">
                    ...
                    <div class="swiper-slide  swiper-slide-prev">
                        <div><a href='{$ad['link']}' ><img :data-src='"{$url}"' class='ui swiper-lazy image' style='width: 100%' /></a></div>
                    </div>
                    {/foreach}
                </div><!-- Add Pagination -->
...
<!--            <span class="is-pulled-right has-text-danger"> <i class="iconfont icon-iconfontdongtai Rotation" style="display: inline-block"></i> 浏览量：{$views} 房源数量：{$views_esf +$views_rent }</span>-->
    ...
    <div class="ui mhcms-panel">
        <div class="ui  mhcms-panel-body">
            <div class="columns is-multiline    is-mobile">
                <div class="column is-narrow" style="    width: 94px;font-size: 12px;"><i class="bullhorn icon"></i>新闻头条</div>
                <?php
                ...
                <div class="column" style="height: 33px;overflow: hidden">
                    <div class="swiper-container swiper-container-horizontal new-better-swiper-container" id="index_news" style="">
                        <div  class="swiper-wrapper">
                            {foreach $items as $item}
                            <a data-mha href="{:url('house/content/detail' , ['id'=>$item['id'] , 'cate_id'=>$item['old_data']['cate_id']])}" class="swiper-slide  swiper-slide-prev">
                                {$item.title}
                            </a>
                            {/foreach}
                        </div>
    ...
    <div class="ui index_cate" >
        ...
        <div class="ui " style="    padding-top: 5px;margin-bottom: 0;">
            <div class="swiper-container swiper-container-horizontal new-better-swiper-container" id="index_cate_nav" style="    padding-bottom: 34px;"> <div  class="swiper-wrapper">
                        ...
                        <div class=" columns is-multiline    is-mobile" style="    margin: 0;">
                            ...
                            <div class="is-one-fifth  column" style="padding-left: 15px;padding-right: 15px">
                                <a {$nav.property} class="nav_item" href="{$nav.url}">
                                    ...
                                    {else}
                                    <i class="{$nav.icon} " style="{if $nav.ft_color} color: {$nav.ft_color}; {/if}{if $nav.bg_color}  background: {$nav.bg_color}; {/if}" ></i>
                                    {/if}
                                    {$nav.cate_name}
                                </a>
                            </div>
    ...
    <div class="slider_wraper" style="  background: #fff;">
        <div class="ui  mhcms-panel-body">
            ...
            <div class="swiper-container swiper-container-horizontal new-better-swiper-container" id="index_ad_h" style="overflow: hidden; max-height: 200px;">
                <div  class="swiper-wrapper">
                    {foreach $ads as $ad}
                    <?php
                    if ($ad['image'][0]) {
    ...
    <div class="bk10"></div>
    <div class="video_container" id="ad_video" style="display:block;margin: 0 auto;width: 100%;height: 0px;padding-bottom: 55.2%;overflow: hidden;">

        <div class="pause needsclick"></div>
        <img :data-src="'{$ad_videos.0.image.0.url}'" class="poster" style="min-height:22.7rem;">

        <video id="player" src="{$ad_videos.0.media.0.url}" x5-video-player-type="h5" x5-video-player-fullscreen="true" playsinline="true" webkit-playsinline="true" poster="{$ad_videos.0.image.0.url}" style="width: 100%;height: 100%">
        ...
        <div class="video-controls">
            ...
            <div class="video-seek clearfix">
                ...
                <div class="video-time">
                    <span class="video-time__current"> 0 </span> <span class="video-time__plus"> / </span>
...
{if(count($rec_loupan['items']))}
    ...
    <div class="ui mhcms-panel">
        ...
        <div class="ui  mhcms-panel-header" >
            ...
            <a class="is-pulled-right" href="{:url('house/loupan/index')}"><small class="has-text-grey-light">查看更多楼盘 <i class="icon angle right
"></i></small></a>
        </div>
        <div class="ui  mhcms-panel-body">
            ...
            <div class="columns is-multiline is-mobile">
                ...
                ?>
                <a  href="{:url('house/loupan/detail' , ['id'=>$item['id'] ])}" class="column is-half {if $i%2 !== 0} even {else} odd {/if}" style="padding:10px 20px">

                     <div  class=" image tiny ui" > <img :data-src="'{$url|default=$_W['module_config']['default_thumb']}'"  ></div>

                    <div class="content">
                        <div style="line-height: 1.9em;font-size: 14px;" class="header mhcms-item-header">{$item.loupan_name}</div>
...
{/if}
    ...
    <div class="ui mhcms-panel" id="rent_esf">
        <div class="ui  mhcms-panel-header weui-flex has-text-centered" >
            <div class="weui-flex__item" @click="show_esf=true" v-bind:class="{ active:show_esf==true }"><span>最新二手房源</span></div>
            <div class="weui-flex__item" @click="show_esf=false"  v-bind:class="{ active:show_esf==false }"><span>最新出租房源</span></div>
        </div>
        ...
        <div class="ui  mhcms-panel-body">
            <div class="ui mhcms-list unstackable items" v-show="show_esf">
                ...
                ?>
                <a  href="{:url('house/esf/detail' , ['id'=>$item['id']])}" class="ui item mhcms-list-item ">
                    {if $url}<div  class=" image tiny ui"> <img :data-src="'{$url}'"  > </div>{/if}
                    <div class="content">
                        <div class="header" style="    font-size: 14px;"> {if $item.old_data.is_top==1}
                            <em class="top">顶</em>
                            {/if} {$item.title}
                        </div>
                        <div class="extra">
                        ...
                        <div class="extra">
                            ...
                            <small class="has-text-gray"> 浏览 <?php echo ($item['hits']['base'] + $item['hits']['views']);?></small>
                            {if $item.price}
            ...
            <div class="ui mhcms-list unstackable items"  v-show="!show_esf">
                ...
                ?>
                <a  href="{:url('house/rent/detail' , ['id'=>$item['id']])}" class="ui item mhcms-list-item ">
                    {if $url}<div  class=" image tiny ui"> <img :data-src="'{$url}'"  > </div>{/if}
                    <div class="content">
                        <div class="header" style="    font-size: 14px;"> {if $item.old_data.is_top==1}
                            <em class="top">顶</em>
    ...
    <div class="ui mhcms-panel">
        ...
        <div class="ui  mhcms-panel-body">
            <div class="ui mhcms-list unstackable items">
                ...
                ?>
                <a class="ui item mhcms-list-item "  data-mha style="    font-size: 14px;" href="{:url('house/content/detail' , ['id'=>$item['id'] , 'cate_id'=>$item['old_data']['cate_id']])}">
                   <div data-mha  class=" image tiny ui"> <img :data-src="'{$url|default=$_W['module_config']['default_thumb']}'"  > </div>
                    <div class="content">
                        <div class="header" >{$item.title}</div>
                        <div class="extra">
                            <small class="has-text-gray">{:format_date($item.create_at)}</small> <span class="fly-list-nums"> <i class="talk outline icon" title="浏览"></i> {$item.hits.views} </span>
                        </div>
                    </div>
                </a>
                {/foreach}
...
<script>
    ...
    require(['jquery' , 'swiper4', 'mhcms'] , function ($ , Swiper , mhcms) {
        $(document).ready(function () {
            ...
            //mhcms.mhcms_player("ad_video");
            // {if $ad_videos['has_ads']}


            mhcms.common_player("ad_video");
