...
<div class="weui-panel">
    <div class="weui-panel__hd">内部经纪人面板</div>
    <div class="weui-panel__bd">
        <div class="weui-media-box weui-media-box_small-appmsg">
            <div class="weui-cells">

                <a class="weui-cell weui-cell_access"  href="/house/employee_orders/index/status/0.html">
                ...
                <a class="is-hidden"  ><i class="icon wait"></i>我的店铺 / 录入房源</a>
            </div>
        </div>
    </div>
</div>
