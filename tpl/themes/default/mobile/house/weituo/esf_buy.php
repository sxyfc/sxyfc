...
<div id="app_mhcms">
    <div class="weui-cells weui-cells_form">
        ...
        <mhui_input_text :field_name="'price'"  :type="'number'" :text="'价格'" :placeholder="'你的期望价格'" :unit="'万元'" @applied="apply"></mhui_input_text>
    ...
    <div class="weui-btn-area">
        <button class="weui-btn weui-btn_primary" :disabled="disabled" @click="save()"  id="showTooltips">确定</button>
    </div>
