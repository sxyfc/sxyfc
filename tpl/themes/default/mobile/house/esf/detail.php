        ...
        <div class="columns is-mobile is-marginless is-multiline">
            ...
            <div class="column is-half">
                <div class="columns option is-mobile is-marginless">
                    ...
                    <div class="column has-text-danger"><?php echo  (int)($detail['price'] / $detail['size'] * 10000); ?>元</div>
                </div>
            </div>
        ...
        <div class="weui-msg__extra-area">
            <div class="weui-footer">
                <p class="weui-footer__links">
                    <a href="javascript:void(0);" class="weui-footer__link">{$_W.global_config.system_name}</a>
                </p>
