...
<div class="mhcms-panel" style="padding-top: 15px">
    <div class="mhcms-panel-body">
        <div class="columns is-mobile user-btns has-text-centered">
            <div class=" column">
                <a data-mha  href="/house/weituo/esf_buy">
            ...
            <div class="  column">
                <a data-mha  href="/house/weituo/rent_add" data-model_id="resume">
                    <div class="weui-cell__bd weui-cell_primary">
        ...
        <div class="columns is-mobile user-btns has-text-centered weui-cells" >
            ...
            <div class="  column" >
                <a href="/house/weituo/create?type=1" >
                    <div class="weui-cell__bd weui-cell_primary">
            ...
            <div class="  column" >
                <a href="/house/weituo/create?type=2">
                    <div class="weui-cell__bd weui-cell_primary">
        ...
        <div class="weui-media-box weui-media-box_small-appmsg">
            <div class="weui-cells">
                ...
                <a class="weui-cell weui-cell_access" href="/member/info/verify">
                    <div class="weui-cell__hd"><i class="iconfont icon-renzheng"   style="width:20px;margin-right:5px;display:block"></i></div>
                    <div class="weui-cell__bd weui-cell_primary">
                        <p>申请个人认证</p>
                    </div>
                ...
                <a class="weui-cell weui-cell_access" href="/member/info/verify?type=company">
                    <div class="weui-cell__hd"><i class=" iconfont icon-renzhengpeizhi"   style="width:20px;margin-right:5px;display:block"></i></div>
                    <div class="weui-cell__bd weui-cell_primary">
                        <p>申请公司认证</p>
                    </div>
                    <span class="weui-cell__ft"></span>
        ...
        <div class="weui-media-box weui-media-box_small-appmsg">
            <div class="weui-cells">
                ...
                <a class="weui-cell weui-cell_access" href="/house/user_content/my_esf_lists">
                    <div class="weui-cell__hd"><i class="iconfont icon-xiaoqu"   style="width:20px;margin-right:5px;display:block"></i></div>
                    <div class="weui-cell__bd weui-cell_primary">
                        <p>二手房管理</p>
                    </div>
                    <span class="weui-cell__ft"></span>
                ...
                <a class="weui-cell weui-cell_access" href="/house/user_content/my_rent_lists">
                    <div class="weui-cell__hd"><i class="iconfont icon-woyaochuzu"   style="width:20px;margin-right:5px;display:block"></i></div>
                    <div class="weui-cell__bd weui-cell_primary">
                        <p>出租管理</p>
                    </div>
                    <span class="weui-cell__ft"></span>
        ...
        <div class="weui-media-box weui-media-box_small-appmsg">
            <div class="weui-cells">
                <a class="weui-cell weui-cell_access"  href="/member/distribute/orders/module/house">
                    <div class="weui-cell__hd"><i class="iconfont icon-wodedingdan"   style="width:20px;margin-right:5px;display:block"></i></div>
                    <div class="weui-cell__bd weui-cell_primary">
                        <p>分销订单</p>
                    </div>
                    <span class="weui-cell__ft"></span>
                ...
                <a class="weui-cell weui-cell_access" href="/member/distribute/link">
                    <div class="weui-cell__hd"><i class="iconfont icon-shangjiaruzhu"   style="width:20px;margin-right:5px;display:block"></i></div>
                    <div class="weui-cell__bd weui-cell_primary">
                        <p>推广链接</p>
                    </div>
                    <span class="weui-cell__ft"></span>
...
<div class="weui-cells">
    ...
    <a class="weui-cell weui-cell_access"  href="{:url('sso/passport/logout')}">
        <div class="weui-cell__hd"><i class="iconfont icon-back"   style="width:20px;margin-right:5px;display:block"></i></div>
        <div class="weui-cell__bd weui-cell_primary">
            <p>注销登录</p>
        </div>
        <span class="weui-cell__ft"></span>
