...
class AdminDistributeLevel extends AdminBase
{

    private $distribute_level = "distribute_level";

    public function index()
    {
        global $_W;
        $content_model_id = $this->distribute_level;
    ...
    {
        global $_W, $_GPC;
        $model = set_model($this->distribute_level);
        /** @var Models $model_info */
        $model_info = $model->model_info;
        if ($this->isPost()) {
