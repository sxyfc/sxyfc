...
use app\pay\payment\micropay\utils\WxPayException;
use app\pay\payment\micropay\utils\WxPayJsApiPay;
...
class JsApiPay
{
    ...
    {
        global $_W;
        $this->WxPayConfig = $_W['WxPayConfig'];
    }
     ...
     *
     * @return $parameters json数据，可直接填入js函数作为参数
     */
    ...
    public function GetOpenidFromMp($code)
    {
        ...
        if($this->WxPayConfig->CURL_PROXY_HOST != "0.0.0.0"
     ...
     * 获取地址js参数
     *
     * @return $parameters 获取共享收货地址js函数需要的参数，json格式可以直接做参数使用
     */
    public function GetEditAddressParameters()
    {
        ...
        $getData = $this->data;
        $data = array();
        $data["appid"] = $this->WxPayConfig->APPID;
