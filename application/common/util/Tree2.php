...
class Tree2
{
     ...
     * @return string
     */
    public function get_tree($parent_id, $str, $selected_id = 0, $prefix = '', $str_group = '')
    {
        $number = 1;
        ...
        if (is_array($children)) {
            ...
            foreach ($children as $id => $child) {
                ...
                $this->ret .= $nstr;
                $nbsp = $this->nbsp;
                $this->get_tree($id, $str, $selected_id, $prefix . $k . $nbsp, $str_group);
                $number++;
            }
        }
        return $this->ret;
