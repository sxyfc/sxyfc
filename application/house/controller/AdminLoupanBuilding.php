...
class AdminLoupanBuilding extends AdminBase
{
    private $house_loupan_building = "house_loupan_building";

    public function index($loupan_id)
    {
        global $_W;
        $content_model_id = $this->house_loupan_building;
    ...
    {
        global $_W, $_GPC;
        $model = set_model($this->house_loupan_building);
        /** @var Models $model_info */
        $model_info = $model->model_info;
        if ($this->isPost()) {
